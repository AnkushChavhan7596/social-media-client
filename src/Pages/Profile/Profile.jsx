...
const Profile = () => {
  ...
  const handleLogOut = () => {
    ...
    Swal.fire("Greate", "Logged out Successfully", "success");
  ...
  const handleProfileSubmit = async (e) => {
    ...
    const res = await axios.post(
      "https://social-media-ankush.herokuapp.com/post/update/profile-pic",
      formData
    );
  ...
  const handleDeletePost = async (id) => {
    try {
      const res = await axios.post(
        `https://social-media-ankush.herokuapp.com/post/delete/${id}`
      );
      ...
      Swal.fire("Greate", error, "success");
      console.log(error);
    }
  };
          ...
          <div className="profile_wrapper">
            <div className="profile_header">
                  ...
                  <div className="posts_count">
                    <p>
                      ...
                      <span>
                        {
                          posts.filter(
                            (post) => post.authorID === activeUser._id
                          ).length
                        }
                      </span>
                    </p>
                    <p className="joined_at">
                      Joined At : {format(activeUser.timestamp)}
                    </p>
                  </div>
              ...
              <div className="profile_right">
                <i
                  className="fas fa-cog setting_btn"
                ...
                <div className="change_img_wrapper">
                  ...
                  >
                    <input
                      ...
                      className="profile_pic_change_input"
                      required
                    />
                ...
                <div className={`setting_modal ${settingModal}`}>
                  <Link to="/" className="setting_modal_links">
                    Contact Us
                  </Link>
                  <Link to="/" className="setting_modal_links">
                    Change password
            ...
            <div className="profile_body">
              <div className="profile_body_heading">
                ...
                <div className="profile_posts_wrapper">
                  {posts.filter((post) => post.authorID === activeUser._id)
                    .length == 0 ? (
                    <h3 className="no_posts">No Posts Yet 😞</h3>
                  ) : (
                    posts
                      .filter((post) => post.authorID === activeUser._id)
                      .map((post) => {
                        return (
